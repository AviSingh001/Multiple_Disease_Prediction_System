...
diabetes_model=pickle.load(open("E:\Multiple_Disease_Prediction_System\Models\Diabetes .pkl",'rb'))

heart_model=pickle.load(open("E:\Multiple_Disease_Prediction_System\Models\Heart_disease.pkl",'rb'))

kidney_model=pickle.load(open("E:\Multiple_Disease_Prediction_System\Models\Kidney_Disease.pkl",'rb'))
...
if selected =='Diabetes Prediction':
   ...
   if st.button("Diabetes Test Result"):
      ...
      user_input=[Pregnancies,Glucose,BloodPressure,SkinThickness,Insulin,BMI,DiabetesPedigreeFunction,Age,
                  NewBMI_OverWeight,NewBMI_UnderWeight,NewBMI_Obesity_1,NewBMI_Obesity_2, NewBMI_Obesity_3,
